 ...
 * @author guanyifeng
 */
public class TRTCAudioCall2Activity extends AppCompatActivity {
    private static final String TAG = TRTCAudioCall2Activity.class.getName();
    ...
    public static void startCallSomeone(Context context, List<UserModel> models) {
        Intent starter = new Intent(context, TRTCAudioCall2Activity.class);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.audiocall_activity_call_main2);
