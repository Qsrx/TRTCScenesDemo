...
import com.tencent.liteav.trtcaudiocalldemo.ui.TRTCAudioCall2Activity;
                    ...
                    if (!CollectionUtils.isEmpty(userIdList)) {
                        ProfileManager.getInstance().getUserInfoBatch(userIdList, new ProfileManager.GetUserInfoBatchCallback() {
                            ...
                            public void onSuccess(List<UserModel> modelList) {
                                TRTCAudioCall2Activity.startBeingCall(CallService.this, model, modelList);
                            }

                            @Override
                            public void onFailed(int code, String msg) {
                                TRTCAudioCall2Activity.startBeingCall(CallService.this, model, null);
                            }
                        });
                    } else {
                        TRTCAudioCall2Activity.startBeingCall(CallService.this, model, null);
